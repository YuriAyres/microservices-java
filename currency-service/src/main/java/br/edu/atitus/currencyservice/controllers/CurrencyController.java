        ...
        if (source.equals(target)) {
            ...
            try {
                ...
                if (!source.equals("BRL")) {
                    ...
                    String nameCache = "BCBValue";
                    String keyCache = source;

                    Double convertedValue = cacheManager
                            .getCache(nameCache)
                            .get(keyCache, Double.class);
                    ...
                    if (convertedValue == null) {
                        ...
                        cacheManager
                                .getCache(nameCache)
                                .put(keyCache, sourceRate);

                    } else {

                        sourceRate = convertedValue;
                    }
                }
                ...
                if (!target.equals("BRL")) {
                    ...
                    if (convertedValue == null) {
                        ...
                        cacheManager
                                .getCache(nameCache)
                                .put(keyCache, targetRate);

                    } else {

                        targetRate = convertedValue;
                    }
                }
