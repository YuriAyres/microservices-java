...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> getProduct(
        ...
        if (targetCurrency.equals(entity.getCurrency())) {
            ...
            Double convertedValue=null; //Para testar sem cache
    ...
    public ResponseEntity<Page<ProductDTO>> getAllProducts(
            ...
            ) DataWebProperties.Pageable pageable) throws Exception {

        Page<ProductEntity> products = repository.findAll((Pageable) pageable);
